...
public class OrderActivity extends AppCompatActivity {
    ...
    private void createFoodListView() {
        ...
        FoodAdapter foodAdapter = new FoodAdapter(OrderActivity.this,
                iconStrings,
                foodStrings,
                priceStrings);
    ...
    private void confirmOrder() {
        ...
        builder.setMessage("Office = " + officerString + "\n" +
                "Desk = " + deskString + "\n" +
                "Food = " + foodString + "\n" +
                "Amount = " + amountString);
    ...
    private void createdeskSpinner() {
        ...
        final String[] deskStrings = {"โต๊ะ 1,โต๊ะ 2,โต๊ะ 3,โต๊ะ 4,โต๊ะ 5,โต๊ะ 6," +
                "โต๊ะ 7,โต๊ะ 8,โต๊ะ 9,โต๊ะ 10,"};
